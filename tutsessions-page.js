    ...
    window.loadSessions = async () => {
      const container = document.getElementById('sessions-container');
      if (container) {
        container.innerHTML = '<div class="loading">Loading your sessions…</div>';
      }
    ...
    function renderSessions(sessions) {
      ...
      if (pendingDisplayItems.length > 0) {
        ...
        finalHtml += renderTable(pendingDisplayItems, '⏳ Pending Sessions', {
          headerActions,
          tableKey: 'pending',
        ...
        finalHtml += `
          <div class="data-table" style="margin-top: 1.5rem;">
            <div class="empty-state" style="margin: 0; border-style: solid;">
              <h3 style="margin-bottom: 0.5rem;">📅 Upcoming Sessions</h3>
      ...
      if (pastDisplayItems.length > 0) {
        ...
        finalHtml += `
          <div class="data-table" style="margin-top: 2rem;">
            <div class="empty-state" style="margin: 0; border-style: solid;">
              <h3 style="margin-bottom: 0.5rem;">📚 Past Sessions</h3>
    ...
    window.approveSelectedSessions = async () => {
      ...
      try {
        ...
        let message = `✅ Approved ${results.success.length} session(s)`;
